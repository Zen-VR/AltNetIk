...
namespace AltNetIk
{
    ...
    {
        public void OnPacketReceived(PacketData packet)
        {
            if (!IsReceiving)
                return;
        ...
        public void OnParamPacketReceived(ParamData packet)
        {
            if (!IsReceiving)
                return;
        ...
        private void ToggleFreeze(int photonId, bool frozen)
        {
            bool hasBoneData = receiverPlayerData.TryGetValue(photonId, out PlayerData boneData);
            if (!hasBoneData)
                return;
        ...
        private void RemoveFreeze(int photonId)
        {
